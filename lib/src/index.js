...
var run_generator_1 = __importDefault(require("./core/run_generator"));
var register_commander_1 = __importDefault(require("./core/register_commander"));
...
console.log(path_1.default.join(osenv_1.default.home(), '.puppy/.puppy.yml'));
// const cache = fs.readFileSync(path.join(osenv.home(), '.puppy/.puppy.yml'), {encoding: 'utf-8'});
...
//创建业务项目
if (program.create) {
    run_generator_1.default(program.create, program.args[0]);
...
register_commander_1.default("new", {
    abbreviation: "-ne",
    description: "测试测试",
    core: false
}, function () {
